...
//    stbi_set_flip_vertically_on_load(true); ne treba mi

    programState = new ProgramState;
    programState->LoadFromFile("resources/program_state.txt"); //u datoteci program_state.txt se nalaze pocetna stanja tj pozicije svega, mogu to izmeniti, stavila sam 4. liniju na 0 jer necu ImGui
    ...
    Shader skyboxShader("resources/shaders/skybox.vs", "resources/shaders/skybox.fs"); //TODO
//BEGIN  skybox coordinates
    ...
    vector<std::string> faces
            {
                    FileSystem::getPath("resources/textures/Lycksele3/posx.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele3/negx.jpg"),

                    FileSystem::getPath("resources/textures/Lycksele3/posy.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele3/negy.jpg"),

                    FileSystem::getPath("resources/textures/Lycksele3/posz.jpg"),

                    FileSystem::getPath("resources/textures/Lycksele3/negz.jpg")
            };
...
//OVO JE FUNKCIJA ZA CRTANJE ONIH INFORMACIJA, NIJE MI BITNA
void DrawImGui(ProgramState *programState) {
